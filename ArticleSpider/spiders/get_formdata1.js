 function t(e) {
    ...
    function G() {
        this.r = [0, 0, 0, 0], this.C = 0, this.Q = [], this.k = [], this.B = [], this.f = [], this.g = [], this.u = !1, this.G = [], this.b = [], this.o = !1, this.w = null, this.U = null, this.F = [], this.R = 0, this.J = { 0: s, 1: i, 2: h, 3: a, 4: c, 5: n, 6: e, 7: o, 8: r, 9: Q, 10: C, 11: B, 12: f, 13: g, 14: u, 15: w };
    }
    Q.prototype.e = function (e) {
        ...
        var r = function (r) {
            var a = new G;
            return a.k = n, a.k[0] = r, a.v(e.G, t.h, e.b, e.F), a.r[3];
        };
        r.toString = function () {
            return "() { [native code] }";
        }, e.r[3] = r;
        ...
        for (var t = Buffer.from(e,encoding='base64').toString('binary'), n = t.charCodeAt(0) << 8 | t.charCodeAt(1), r = [], a = 2; a < n + 2; a += 2)
            r.push(t.charCodeAt(a) << 8 | t.charCodeAt(a + 1));
        this.G = r;
        for (var o = [], i = n + 2; i < t.length;) {
            var s = t.charCodeAt(i) << 8 | t.charCodeAt(i + 1), c = t.slice(i + 2, i + 2 + s);
            o.push(c), i += s + 2;
        }
        this.b = o;
